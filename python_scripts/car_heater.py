#logger.warning("running car_heater.py")
...
if hass.states.get(temperature_sensor_id) is None:
	logger.error("Cannot find temperature sensor with entity_id: \"{}\"".format(temperature_sensor_id))
else:
	...
	#	logger.warning("CAR_HEATER {}".format(3))
		...
		#logger.warning("CAR_HEATER {} temp {} obj {} ".format(4, temperature, temperature_sensor_id))
